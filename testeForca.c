...
int entrada();            // Le a letra fornecida pelo usu�rio.
...
int erros=0;
int on_0 = 1, on_1 = 1, on_2 = 1, on_3 = 1;
...
"Santos Dumont","Graham Bell","Mozart", "Aristoteles","Arquimedes","Caetano Veloso","Candido Portinari",/*68-74*/
...
//______________________________________________________________________________
// Exibe as Opções
// Para mais explicações sobre os menus do jogo veja a fun��o Menu()
...
//______________________________________________________________________________
//Le o palpite, com o cuidado de descartar entradas inv�lidas.
